...
**YOU ARE IN: `hall/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/hall/` (rig root) or other directories
...
**Your mail address:** `hall/polecats/rust`
**Your rig:** hall
**Your Witness:** `hall/witness`
...
| Ask Witness for help | `gt mail send hall/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`hall/witness`) when:
...
```bash
gt mail send hall/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
